...
class RowRegenMapper extends ClassMapperBase<RowRegen> {
  RowRegenMapper._();

  static RowRegenMapper? _instance;
  static RowRegenMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = RowRegenMapper._());
      RegenStrategyMapper.ensureInitialized();
    }
    return _instance!;
  }
  ...
  @override
  final String id = 'RowRegen';

  static String _$tableId(RowRegen v) => v.tableId;
  static const Field<RowRegen, String> _f$tableId = Field(
    'tableId',
    _$tableId,
    key: r'table_id',
  );
  static String _$rowId(RowRegen v) => v.rowId;
  static const Field<RowRegen, String> _f$rowId = Field(
    'rowId',
    _$rowId,
    key: r'row_id',
  );
  static RegenStrategy _$regenStrategy(RowRegen v) => v.regenStrategy;
  static const Field<RowRegen, RegenStrategy> _f$regenStrategy = Field(
    'regenStrategy',
    _$regenStrategy,
  ...
  static String? _$outputColumnId(RowRegen v) => v.outputColumnId;
  static const Field<RowRegen, String> _f$outputColumnId = Field(
    'outputColumnId',
    _$outputColumnId,
    key: r'output_column_id',
    opt: true,
  );
  static bool _$stream(RowRegen v) => v.stream;
  static const Field<RowRegen, bool> _f$stream = Field(
    'stream',
    _$stream,
    opt: true,
    def: true,
  );
  static bool _$concurrent(RowRegen v) => v.concurrent;
  static const Field<RowRegen, bool> _f$concurrent = Field(
    'concurrent',
    _$concurrent,
    opt: true,
    def: true,
  ...
  @override
  final MappableFields<RowRegen> fields = const {
    #tableId: _f$tableId,
    #rowId: _f$rowId,
  ...
  static RowRegen _instantiate(DecodingData data) {
    return RowRegen(
      tableId: data.dec(_f$tableId),
      rowId: data.dec(_f$rowId),
  ...
  static RowRegen fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<RowRegen>(map);
  }

  static RowRegen fromJson(String json) {
    return ensureInitialized().decodeJson<RowRegen>(json);
  }
}

mixin RowRegenMappable {
  String toJson() {
    return RowRegenMapper.ensureInitialized().encodeJson<RowRegen>(
      this as RowRegen,
    );
  }

  Map<String, dynamic> toMap() {
    return RowRegenMapper.ensureInitialized().encodeMap<RowRegen>(
      this as RowRegen,
    );
  }

  RowRegenCopyWith<RowRegen, RowRegen, RowRegen> get copyWith =>
      _RowRegenCopyWithImpl<RowRegen, RowRegen>(
        this as RowRegen,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return RowRegenMapper.ensureInitialized().stringifyValue(this as RowRegen);
  }

  @override
  bool operator ==(Object other) {
    return RowRegenMapper.ensureInitialized().equalsValue(
      this as RowRegen,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return RowRegenMapper.ensureInitialized().hashValue(this as RowRegen);
  }
}

extension RowRegenValueCopy<$R, $Out> on ObjectCopyWith<$R, RowRegen, $Out> {
  RowRegenCopyWith<$R, RowRegen, $Out> get $asRowRegen =>
      $base.as((v, t, t2) => _RowRegenCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class RowRegenCopyWith<$R, $In extends RowRegen, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  $R call({
    String? tableId,
    String? rowId,
  ...
  RowRegenCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _RowRegenCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, RowRegen, $Out>
    implements RowRegenCopyWith<$R, RowRegen, $Out> {
  _RowRegenCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<RowRegen> $mapper =
      RowRegenMapper.ensureInitialized();
  @override
  $R call({
    String? tableId,
    String? rowId,
  ...
  @override
  RowRegen $make(CopyWithData data) => RowRegen(
    tableId: data.get(#tableId, or: $value.tableId),
    rowId: data.get(#rowId, or: $value.rowId),
  ...
  @override
  RowRegenCopyWith<$R2, RowRegen, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  ) => _RowRegenCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
